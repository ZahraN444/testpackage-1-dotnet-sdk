// <copyright file="MigrationFrom.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<MigrationFrom>),
        new Type[] {
            typeof(MigrationInstanceCase)
        },
        false
    )]
    public abstract class MigrationFrom
    {
        /// <summary>
        /// This is MigrationInstance case.
        /// </summary>
        /// <returns>
        /// The MigrationFrom instance, wrapping the provided MigrationInstance value.
        /// </returns>
        public static MigrationFrom FromMigrationInstance(MigrationInstance migrationInstance)
        {
        ...
        private sealed class MigrationInstanceCase : MigrationFrom, ICaseValue<MigrationInstanceCase, MigrationInstance>
        {
