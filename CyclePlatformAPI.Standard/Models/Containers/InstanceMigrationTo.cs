// <copyright file="InstanceMigrationTo.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<InstanceMigrationTo>),
        new Type[] {
            typeof(MigrationInstanceCase)
        },
        false
    )]
    public abstract class InstanceMigrationTo
    {
        /// <summary>
        /// This is MigrationInstance case.
        /// </summary>
        /// <returns>
        /// The InstanceMigrationTo instance, wrapping the provided MigrationInstance value.
        /// </returns>
        public static InstanceMigrationTo FromMigrationInstance(MigrationInstance migrationInstance)
        {
        ...
        private sealed class MigrationInstanceCase : InstanceMigrationTo, ICaseValue<MigrationInstanceCase, MigrationInstance>
        {
