// <copyright file="LoadbalancerConfig.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<LoadbalancerConfig>),
        new Type[] {
            typeof(Case0)
        },
        false
    )]
    public abstract class LoadbalancerConfig
    {
        /// <summary>
        /// This is LoadBalancerConfig case.
        /// </summary>
        /// <returns>
        /// The LoadbalancerConfig instance, wrapping the provided LoadBalancerConfig value.
        /// </returns>
        public static LoadbalancerConfig FromLoadBalancerConfig(LoadBalancerConfig loadBalancerConfig)
        {
        ...
        private sealed class Case0 : LoadbalancerConfig, ICaseValue<Case0, LoadBalancerConfig>
        {
