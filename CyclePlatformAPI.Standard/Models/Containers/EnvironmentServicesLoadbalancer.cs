// <copyright file="EnvironmentServicesLoadbalancer.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<EnvironmentServicesLoadbalancer>),
        new Type[] {
            typeof(LoadBalancerEnvironmentServiceCase)
        },
        false
    )]
    public abstract class EnvironmentServicesLoadbalancer
    {
        /// <summary>
        /// This is LoadBalancerEnvironmentService case.
        /// </summary>
        /// <returns>
        /// The EnvironmentServicesLoadbalancer instance, wrapping the provided LoadBalancerEnvironmentService value.
        /// </returns>
        public static EnvironmentServicesLoadbalancer FromLoadBalancerEnvironmentService(LoadBalancerEnvironmentService loadBalancerEnvironmentService)
        {
        ...
        private sealed class LoadBalancerEnvironmentServiceCase : EnvironmentServicesLoadbalancer, ICaseValue<LoadBalancerEnvironmentServiceCase, LoadBalancerEnvironmentService>
        {
