// <copyright file="InstanceDeployment.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<InstanceDeployment>),
        new Type[] {
            typeof(DeploymentCase)
        },
        false
    )]
    public abstract class InstanceDeployment
    {
        /// <summary>
        /// This is Deployment case.
        /// </summary>
        /// <returns>
        /// The InstanceDeployment instance, wrapping the provided Deployment value.
        /// </returns>
        public static InstanceDeployment FromDeployment(Deployment deployment)
        {
        ...
        private sealed class DeploymentCase : InstanceDeployment, ICaseValue<DeploymentCase, Deployment>
        {
