// <copyright file="EnvironmentServiceSummaryScheduler.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<EnvironmentServiceSummaryScheduler>),
        new Type[] {
            typeof(EnvironmentServiceContainerSummaryCase)
        },
        false
    )]
    public abstract class EnvironmentServiceSummaryScheduler
    {
        /// <summary>
        /// This is EnvironmentServiceContainerSummary case.
        /// </summary>
        /// <returns>
        /// The EnvironmentServiceSummaryScheduler instance, wrapping the provided EnvironmentServiceContainerSummary value.
        /// </returns>
        public static EnvironmentServiceSummaryScheduler FromEnvironmentServiceContainerSummary(EnvironmentServiceContainerSummary environmentServiceContainerSummary)
        {
        ...
        private sealed class EnvironmentServiceContainerSummaryCase : EnvironmentServiceSummaryScheduler, ICaseValue<EnvironmentServiceContainerSummaryCase, EnvironmentServiceContainerSummary>
        {
