// <copyright file="StackBuildSpec.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<StackBuildSpec>),
        new Type[] {
            typeof(StackSpecCase)
        },
        false
    )]
    public abstract class StackBuildSpec
    {
        /// <summary>
        /// This is StackSpec case.
        /// </summary>
        /// <returns>
        /// The StackBuildSpec instance, wrapping the provided StackSpec value.
        /// </returns>
        public static StackBuildSpec FromStackSpec(StackSpec stackSpec)
        {
        ...
        private sealed class StackSpecCase : StackBuildSpec, ICaseValue<StackSpecCase, StackSpec>
        {
