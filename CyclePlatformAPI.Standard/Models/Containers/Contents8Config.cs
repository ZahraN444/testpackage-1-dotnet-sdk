// <copyright file="Contents8Config.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<Contents8Config>),
        new Type[] {
            typeof(Case0)
        },
        false
    )]
    public abstract class Contents8Config
    {
        /// <summary>
        /// This is LoadBalancerConfig case.
        /// </summary>
        /// <returns>
        /// The Contents8Config instance, wrapping the provided LoadBalancerConfig value.
        /// </returns>
        public static Contents8Config FromLoadBalancerConfig(LoadBalancerConfig loadBalancerConfig)
        {
        ...
        private sealed class Case0 : Contents8Config, ICaseValue<Case0, LoadBalancerConfig>
        {
