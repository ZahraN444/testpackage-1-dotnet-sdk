// <copyright file="PrivateNetwork1Legacy.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PrivateNetwork1Legacy>),
        new Type[] {
            typeof(LegacyNetworkCase)
        },
        false
    )]
    public abstract class PrivateNetwork1Legacy
    {
        /// <summary>
        /// This is LegacyNetwork case.
        /// </summary>
        /// <returns>
        /// The PrivateNetwork1Legacy instance, wrapping the provided LegacyNetwork value.
        /// </returns>
        public static PrivateNetwork1Legacy FromLegacyNetwork(LegacyNetwork legacyNetwork)
        {
        ...
        private sealed class LegacyNetworkCase : PrivateNetwork1Legacy, ICaseValue<LegacyNetworkCase, LegacyNetwork>
        {
