// <copyright file="InstanceMigrationFrom.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<InstanceMigrationFrom>),
        new Type[] {
            typeof(MigrationInstanceCase)
        },
        false
    )]
    public abstract class InstanceMigrationFrom
    {
        /// <summary>
        /// This is MigrationInstance case.
        /// </summary>
        /// <returns>
        /// The InstanceMigrationFrom instance, wrapping the provided MigrationInstance value.
        /// </returns>
        public static InstanceMigrationFrom FromMigrationInstance(MigrationInstance migrationInstance)
        {
        ...
        private sealed class MigrationInstanceCase : InstanceMigrationFrom, ICaseValue<MigrationInstanceCase, MigrationInstance>
        {
