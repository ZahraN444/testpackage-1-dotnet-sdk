// <copyright file="LatestRouter.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<LatestRouter>),
        new Type[] {
            typeof(LoadBalancerTelemetryRouterMetricsCase)
        },
        false
    )]
    public abstract class LatestRouter
    {
        /// <summary>
        /// This is LoadBalancerTelemetryRouterMetrics case.
        /// </summary>
        /// <returns>
        /// The LatestRouter instance, wrapping the provided LoadBalancerTelemetryRouterMetrics value.
        /// </returns>
        public static LatestRouter FromLoadBalancerTelemetryRouterMetrics(LoadBalancerTelemetryRouterMetrics loadBalancerTelemetryRouterMetrics)
        {
        ...
        private sealed class LoadBalancerTelemetryRouterMetricsCase : LatestRouter, ICaseValue<LoadBalancerTelemetryRouterMetricsCase, LoadBalancerTelemetryRouterMetrics>
        {
