// <copyright file="EnvironmentServiceSummaryLoadbalancer.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<EnvironmentServiceSummaryLoadbalancer>),
        new Type[] {
            typeof(EnvironmentServiceContainerSummaryCase)
        },
        false
    )]
    public abstract class EnvironmentServiceSummaryLoadbalancer
    {
        /// <summary>
        /// This is EnvironmentServiceContainerSummary case.
        /// </summary>
        /// <returns>
        /// The EnvironmentServiceSummaryLoadbalancer instance, wrapping the provided EnvironmentServiceContainerSummary value.
        /// </returns>
        public static EnvironmentServiceSummaryLoadbalancer FromEnvironmentServiceContainerSummary(EnvironmentServiceContainerSummary environmentServiceContainerSummary)
        {
        ...
        private sealed class EnvironmentServiceContainerSummaryCase : EnvironmentServiceSummaryLoadbalancer, ICaseValue<EnvironmentServiceContainerSummaryCase, EnvironmentServiceContainerSummary>
        {
