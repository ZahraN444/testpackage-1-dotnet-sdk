// <copyright file="Details5Existing.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<Details5Existing>),
        new Type[] {
            typeof(ExistingSourceCase)
        },
        false
    )]
    public abstract class Details5Existing
    {
        /// <summary>
        /// This is ExistingSource case.
        /// </summary>
        /// <returns>
        /// The Details5Existing instance, wrapping the provided ExistingSource value.
        /// </returns>
        public static Details5Existing FromExistingSource(ExistingSource existingSource)
        {
        ...
        private sealed class ExistingSourceCase : Details5Existing, ICaseValue<ExistingSourceCase, ExistingSource>
        {
