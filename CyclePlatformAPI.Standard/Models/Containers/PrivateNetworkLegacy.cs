// <copyright file="PrivateNetworkLegacy.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PrivateNetworkLegacy>),
        new Type[] {
            typeof(LegacyNetworkCase)
        },
        false
    )]
    public abstract class PrivateNetworkLegacy
    {
        /// <summary>
        /// This is LegacyNetwork case.
        /// </summary>
        /// <returns>
        /// The PrivateNetworkLegacy instance, wrapping the provided LegacyNetwork value.
        /// </returns>
        public static PrivateNetworkLegacy FromLegacyNetwork(LegacyNetwork legacyNetwork)
        {
        ...
        private sealed class LegacyNetworkCase : PrivateNetworkLegacy, ICaseValue<LegacyNetworkCase, LegacyNetwork>
        {
