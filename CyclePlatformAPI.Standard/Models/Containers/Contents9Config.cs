// <copyright file="Contents9Config.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<Contents9Config>),
        new Type[] {
            typeof(DiscoveryConfigCase)
        },
        false
    )]
    public abstract class Contents9Config
    {
        /// <summary>
        /// This is DiscoveryConfig case.
        /// </summary>
        /// <returns>
        /// The Contents9Config instance, wrapping the provided DiscoveryConfig value.
        /// </returns>
        public static Contents9Config FromDiscoveryConfig(DiscoveryConfig discoveryConfig)
        {
        ...
        private sealed class DiscoveryConfigCase : Contents9Config, ICaseValue<DiscoveryConfigCase, DiscoveryConfig>
        {
