// <copyright file="EnvironmentServiceSummaryDiscovery.cs" company="APIMatic">
...
namespace CyclePlatformAPI.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<EnvironmentServiceSummaryDiscovery>),
        new Type[] {
            typeof(EnvironmentServiceContainerSummaryCase)
        },
        false
    )]
    public abstract class EnvironmentServiceSummaryDiscovery
    {
        /// <summary>
        /// This is EnvironmentServiceContainerSummary case.
        /// </summary>
        /// <returns>
        /// The EnvironmentServiceSummaryDiscovery instance, wrapping the provided EnvironmentServiceContainerSummary value.
        /// </returns>
        public static EnvironmentServiceSummaryDiscovery FromEnvironmentServiceContainerSummary(EnvironmentServiceContainerSummary environmentServiceContainerSummary)
        {
        ...
        private sealed class EnvironmentServiceContainerSummaryCase : EnvironmentServiceSummaryDiscovery, ICaseValue<EnvironmentServiceContainerSummaryCase, EnvironmentServiceContainerSummary>
        {
