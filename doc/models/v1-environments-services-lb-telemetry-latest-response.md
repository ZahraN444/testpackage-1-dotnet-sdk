...
# V1 Environments Services Lb Telemetry Latest Response
...
|  --- | --- | --- | --- |
| `Data` | [`LoadBalancerLatestTelemetry`](../../doc/models/load-balancer-latest-telemetry.md) | Required | Snapshots of the latest load balancer telemetry |
