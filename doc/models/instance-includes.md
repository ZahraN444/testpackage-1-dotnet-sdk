...
| `Servers` | [`Dictionary<string, Server>`](../../doc/models/server.md) | Optional | A resource thats associated with a server. |
...
| `IntegrationsIdentifiers` | `object` | Optional | A map of identifiers to an array of resource IDs that are associated with it. All IDs point to the same type of resource. |
| `Containers` | [`Dictionary<string, Container>`](../../doc/models/container.md) | Optional | A resource thats associated with a contianer. |
| `ContainersIdentifiers` | `object` | Optional | A map of identifiers to an array of resource IDs that are associated with it. All IDs point to the same type of resource. |
