...
| `Sources` | [`Dictionary<string, ImageSource>`](../../doc/models/image-source.md) | Optional | A resource associated with an image source. |
| `SourcesIdentifiers` | `object` | Optional | A map of identifiers to an array of resource IDs that are associated with it. All IDs point to the same type of resource. |
