...
| `Name` | `string` | Optional | A name value. |
| `Components` | [`Dictionary<string, PipelineIncludesComponents>`](../../doc/models/containers/pipeline-includes-components.md) | Optional | This is Dictionary of a container for one-of cases. |
| `ComponentsIdentifiers` | `object` | Optional | A map of identifiers to an array of resource IDs that are associated with it. All IDs point to the same type of resource. |
