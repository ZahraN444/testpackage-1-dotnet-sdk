...
# V1 Infrastructure Servers Response 2
...
|  --- | --- | --- | --- |
| `Data` | [`Server`](../../doc/models/server.md) | Required | The server resource, referring to servers that have been deployed to a Cycle hub. |
