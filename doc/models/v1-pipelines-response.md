...
|  --- | --- | --- | --- |
| `Data` | [`List<Pipeline>`](../../doc/models/pipeline.md) | Required | - |
| `Includes` | [`PipelineIncludes`](../../doc/models/pipeline-includes.md) | Optional | All includable resources linkable to the given pipeline. |
