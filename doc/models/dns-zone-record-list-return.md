...
|  --- | --- | --- | --- |
| `Data` | [`List<DNSRecord>`](../../doc/models/dns-record.md) | Required | - |
| `Includes` | [`RecordIncludes`](../../doc/models/record-includes.md) | Optional | All includable resources linkable to the given records. |
