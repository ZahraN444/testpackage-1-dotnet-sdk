...
|  --- | --- | --- | --- |
| `Data` | [`Network`](../../doc/models/network.md) | Required | SDN Network resource. |
| `Includes` | [`NetworkIncludes`](../../doc/models/network-includes.md) | Optional | All includable resource linkable to the given network. |
