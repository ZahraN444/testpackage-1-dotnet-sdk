...
|  --- | --- | --- | --- |
| `Version` | `string` | Required | A string defining the version of the stack spec. |
...
| `Containers` | [`Dictionary<string, StackContainer>`](../../doc/models/stack-container.md) | Required | Records defining the containers within the stack. |
