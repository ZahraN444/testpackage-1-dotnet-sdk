...
|  --- | --- | --- | --- |
| `Users` | [`CreatorInclude`](../../doc/models/creator-include.md) | Optional | An identity that created a resource. |
| `Components` | [`Dictionary<string, ComponentsIncludes>`](../../doc/models/containers/components-includes.md) | Optional | A resource thats assocaited with activity. |
