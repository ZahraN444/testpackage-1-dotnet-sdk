...
|  --- | --- | --- | --- |
| `Data` | [`List<ImageSource>`](../../doc/models/image-source.md) | Required | - |
| `Includes` | [`SourceIncludes`](../../doc/models/source-includes.md) | Optional | A resource associate with an image source. |
