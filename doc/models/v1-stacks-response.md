...
|  --- | --- | --- | --- |
| `Data` | [`List<Stack>`](../../doc/models/stack.md) | Required | - |
| `Includes` | [`StackIncludes`](../../doc/models/stack-includes.md) | Optional | All includable resources linkable to the given stack. |
