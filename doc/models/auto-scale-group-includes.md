...
| `Models` | [`Dictionary<string, ProviderServerModel>`](../../doc/models/provider-server-model.md) | Optional | A resource associated with a server models. |
