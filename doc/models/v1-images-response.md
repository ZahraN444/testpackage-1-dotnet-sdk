...
|  --- | --- | --- | --- |
| `Data` | [`List<Image>`](../../doc/models/image.md) | Required | - |
| `Includes` | [`ImageIncludes`](../../doc/models/image-includes.md) | Optional | All includable resources linkable to the given image. |
